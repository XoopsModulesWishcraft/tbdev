 ...
 * @access 		public
 */
class TbFormSelectStylesheets extends XoopsFormElement
{
    /**
     * Options
     *
     ...
     */
    function TbFormSelectStylesheets($caption, $name, $value = null, $size = 1, $multiple = false, $none = false)
    {
        ...
        $files = XoopsLists::getFileListAsArray($GLOBALS['xoops']->path('/modules/tb/language/'.$GLOBALS['xoopsConfig']['language'].'/'));
