 ...
 * @access 		public
 */
class TbFormSelectTimezone extends XoopsFormElement
{
    /**
     * Options
     *
     ...
     */
    function TbFormSelectTimezone($caption, $name, $value = null, $size = 1, $multiple = false, $none = false)
    {
        ...
        foreach(XoopsLists::getTimeZoneList() as $key=> $value)
