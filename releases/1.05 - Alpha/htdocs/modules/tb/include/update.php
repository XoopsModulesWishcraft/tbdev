...
function xoops_module_update_tb(&$module) {
	...
	$sql[] = "ALTER TABLE `".$GLOBALS['xoopsDB']->prefix('tb_categories')."` ADD COLUMN `parent_id` int(10) unsigned DEFAULT '0'";
	$sql[] = "ALTER TABLE `".$GLOBALS['xoopsDB']->prefix('tb_torrents')."` ADD COLUMN `tags` varchar(255) DEFAULT ''";
