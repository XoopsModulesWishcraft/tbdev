 ...
 * @access 		public
 */
class TbFormSelectCategory extends XoopsFormElement
{
    /**
     * Options
     *
     ...
     */
    function TbFormSelectCategory($caption, $name, $value = null, $size = 1, $multiple = false, $ownid=0)
    {
		...
		$this->addOption(0, _TBDEV_MI_NONE);
	...
	function GetCategories($ownid){
		...
		$category_handler =& xoops_getmodulehandler('categories', 'tb');
     ...
     *
     * @seealso XShopForm::renderValidationJS
     */
