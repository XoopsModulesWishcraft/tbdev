 ...
 * @access 		public
 */
class TbFormSelectCountry extends XoopsFormElement
{
    /**
     * Options
     *
     ...
     */
    function TbFormSelectCountry($caption, $name, $value = null, $size = 1, $multiple = false, $none = false)
    {
        ...
        if ($none==true)
        	$this->addOption(0, _SHOP_MI_NONE);
        
        $country_handler = xoops_getmodulehandler('countries', 'tb');
        $criteria = new Criteria(1,1);
        $criteria->setSort('`name`');
        
		foreach($country_handler->getObjects($criteria, true) as $country_id => $item)
			$this->addOption($country_id, $item->getVar('name'));
    }
