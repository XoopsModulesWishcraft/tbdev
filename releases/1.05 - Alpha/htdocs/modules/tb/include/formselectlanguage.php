 ...
 * @access 		public
 */
class TbFormSelectLanguage extends XoopsFormElement
{
    /**
     * Options
     *
     ...
     */
    function TbFormSelectLanguage($caption, $name, $value = null, $size = 1, $multiple = false, $none = false)
    {
        ...
        if ($none==true)
        	$this->addOption('', _MI_TBDEV_NONE);
        $language_handler = xoops_getmodulehandler('xlanguage_ext', 'tb');
