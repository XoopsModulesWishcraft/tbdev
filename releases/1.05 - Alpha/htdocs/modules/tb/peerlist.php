...
loggedinorreturn();
    ...
    $GLOBALS['lang'] = array_merge( $GLOBALS['lang'], load_language('peerlist') );
...
function dltable($name, $arr, $torrent)
{
    ...
    $res = $GLOBALS['xoopsDB']->queryF("SELECT * FROM ".$GLOBALS['xoopsDB']->prefix("tb_torrents")." WHERE id = $id")
      or sqlerr();
    ...
    FROM ".$GLOBALS['xoopsDB']->prefix("tb_peers")." p
