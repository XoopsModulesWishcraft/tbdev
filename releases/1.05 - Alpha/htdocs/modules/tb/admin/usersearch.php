...
$GLOBALS['lang'] = array_merge( $GLOBALS['lang'], load_language('ad_usersearch') );
...
print stdhead($GLOBALS['lang']['usersearch_window_title']);
echo "<h1>{$GLOBALS['lang']['usersearch_title']}</h1>\n";
...
if (isset($_GET['h']))
{
	echo $GLOBALS['lang']['usersearch_instructions'];
}
else
{
	echo "<p align='center'>(<a href='admin.php?action=usersearch&amp;h=1'>{$GLOBALS['lang']['usersearch_inlink']}</a>)";
	echo "&nbsp;-&nbsp;(<a href='admin.php?action=usersearch'>{$GLOBALS['lang']['usersearch_reset']}</a>)</p>\n";
}
...
<tr>
  ...
  <td valign="middle" class='rowhead'><?php echo $GLOBALS['lang']['usersearch_name'] ?></td>
  ...
  <td valign="middle" class='rowhead'><?php echo $GLOBALS['lang']['usersearch_ratio'] ?></td>
  ...
  <td valign="middle" class='rowhead'><?php echo $GLOBALS['lang']['usersearch_status'] ?></td>
...
<tr><td valign="middle" class='rowhead'><?php echo $GLOBALS['lang']['usersearch_email'] ?></td>
  ...
  <td valign="middle" class='rowhead'><?php echo $GLOBALS['lang']['usersearch_ip'] ?></td>
  ...
  <td valign="middle" class='rowhead'><?php echo $GLOBALS['lang']['usersearch_acstatus'] ?></td>
...
<tr>
  <td valign="middle" class='rowhead'><?php echo $GLOBALS['lang']['usersearch_comments'] ?></td>
  ...
  <td valign="middle" class='rowhead'><?php echo $GLOBALS['lang']['usersearch_mask'] ?></td>
  ...
  <td valign="middle" class='rowhead'><?php echo $GLOBALS['lang']['usersearch_class'] ?></td>
...
<tr>
    ...
    <td valign="middle" class='rowhead'><?php echo $GLOBALS['lang']['usersearch_joined'] ?></td>
  ...
  <td valign="middle" class='rowhead'><?php echo $GLOBALS['lang']['usersearch_uploaded'] ?></td>
  ...
  <td valign="middle" class="rowhead"><?php echo $GLOBALS['lang']['usersearch_donor'] ?></td>
...
<td valign="middle" class='rowhead'><?php echo $GLOBALS['lang']['usersearch_lastseen'] ?></td>
  ...
  <input name="ls2" type="text" value="<?php echo isset($_POST['ls2'])?$_POST['ls2']:''?>" size="12" maxlength="10" /></td>
	  <td valign="middle" class='rowhead'><?php echo $GLOBALS['lang']['usersearch_downloaded'] ?></td>
  ...
  <?php
	...
	<td valign="middle" class='rowhead'><?php echo $GLOBALS['lang']['usersearch_warned'] ?></td>
...
<tr><td class="rowhead"></td><td></td>
  <td valign="middle" class='rowhead'><?php echo $GLOBALS['lang']['usersearch_active'] ?></td>
  ...
  <td valign="middle" class='rowhead'><?php echo $GLOBALS['lang']['usersearch_banned'] ?></td>
...
if (count($_POST) > 0 );//&& isset($_POST['n']))
{
  ...
  if ($emaila[0] !== "")
  {
    ...
    foreach($emaila as $email)
    {
	    		...
	    		&& strpos($email,'%') === False)
	    {
      	...
      	{
	        stdmsg($GLOBALS['lang']['usersearch_error'], $GLOBALS['lang']['usersearch_bademail']);
	        stdfoot();
	      	die();
	      }
  ...
  if (is_set_not_empty('ip'))
  {
    ...
    {
    	stdmsg($GLOBALS['lang']['usersearch_error'], $GLOBALS['lang']['usersearch_badip']);
    	stdfoot();
    	die();
    }
    ...
    else
    {
        ...
        {
        	stdmsg($GLOBALS['lang']['usersearch_error'], $GLOBALS['lang']['usersearch_badmask']);
        	stdfoot();
          die();
        }
        else
  ...
  if (is_set_not_empty('r'))
  {
    ...
    else
    {
    	...
    	{
      	stdmsg($GLOBALS['lang']['usersearch_error'], $GLOBALS['lang']['usersearch_badratio']);
      	stdfoot();
        die();
      }
      $where_is .= !empty($where_is)?" AND ":"";
      ...
      if ($ratiotype == "3")
      {
        ...
        if(!$ratio2)
        {
        	stdmsg($GLOBALS['lang']['usersearch_error'], $GLOBALS['lang']['usersearch_badratio2']);
        	stdfoot();
          die();
        }
        if (!is_numeric($ratio2) or $ratio2 < $ratio)
        {
        	stdmsg($GLOBALS['lang']['usersearch_error'], $GLOBALS['lang']['usersearch_badratio3']);
        	stdfoot();
        	die();
        }
  ...
  if (is_set_not_empty('ul'))
  {
  	...
  	{
    	stdmsg($GLOBALS['lang']['usersearch_error'], $GLOBALS['lang']['usersearch_badup']);
    	stdfoot();
      die();
    }
    $where_is .= !empty($where_is)?" AND ":"";
    ...
    if ($ultype == "3")
    {
    	...
    	if(!$ul2)
    	{
      	stdmsg($GLOBALS['lang']['usersearch_error'], $GLOBALS['lang']['usersearch_badup2']);
      	stdfoot();
        die();
      }
      if (!is_numeric($ul2) or $ul2 < $ul)
      {
      	stdmsg($GLOBALS['lang']['usersearch_error'], $GLOBALS['lang']['usersearch_badup3']);
      	stdfoot();
        die();
      }
  ...
  if (is_set_not_empty('dl'))
  {
  	...
  	{
    	stdmsg($GLOBALS['lang']['usersearch_error'], $GLOBALS['lang']['usersearch_baddl']);
    	stdfoot();
      die();
    }
    $where_is .= !empty($where_is)?" AND ":"";
    ...
    if ($dltype == "3")
    {
      ...
      if(!$dl2)
      {
      	stdmsg($GLOBALS['lang']['usersearch_error'], $GLOBALS['lang']['usersearch_baddl2']);
      	stdfoot();
        die();
      }
      if (!is_numeric($dl2) or $dl2 < $dl)
      {
      stdmsg($GLOBALS['lang']['usersearch_error'], $GLOBALS['lang']['usersearch_baddl3']);
      	stdfoot();
        die();
      }
  ...
  if (is_set_not_empty('d'))
  {
  	...
  	{
    	stdmsg($GLOBALS['lang']['usersearch_error'], $GLOBALS['lang']['usersearch_baddate']);
    	stdfoot();
      die();
    }
  ...
  if (is_set_not_empty('ls'))
  {
    ...
    else
    {
      ...
      if ($lasttype == "3")
      {
        ...
        {
        	stdmsg($GLOBALS['lang']['usersearch_error'], $GLOBALS['lang']['usersearch_baddate2']);
        	stdfoot();
        	die();
        }
      }
  ...
  {
  	$distinct = "DISTINCT ";
    $join_is .= " LEFT JOIN ".$GLOBALS['xoopsDB']->prefix("tb_peers")." AS p ON u.id = p.userid";
    $q .= ($q ? "&amp;" : "") . "ac=$active";
  }


  $from_is = isset($join_is) ? "".$GLOBALS['xoopsDB']->prefix("tb_users")." AS u".$join_is:"".$GLOBALS['xoopsDB']->prefix("tb_users")." AS u";
...
//    <temporary>    /////////////////////////////////////////////////////
  if ($DEBUG_MODE > 0)
  {
  	stdmsg($GLOBALS['lang']['usersearch_count'],$queryc);
    echo "<br /><br />";
    stdmsg($GLOBALS['lang']['usersearch_query'],$query);
    echo "<br /><br />";
    stdmsg($GLOBALS['lang']['usersearch_url'],$q);
    if ($DEBUG_MODE == 2)
    	stdfoot();
    exit();
  }
//    </temporary>   /////////////////////////////////////////////////////
  ...
  $res = $GLOBALS['xoopsDB']->queryF($queryc) or sqlerr();
  ...
  $res = $GLOBALS['xoopsDB']->queryF($query) or sqlerr();

  if (mysql_num_rows($res) == 0)
  	stdmsg($GLOBALS['lang']['usersearch_warn'],$GLOBALS['lang']['usersearch_nouser']);
  else
  {
  	if ($count > $perpage)
  		echo $pager['pagertop'];
    echo "<table border='1' cellspacing='0' cellpadding='5'>\n";
    echo "<tr><td class='colhead' align='left'>{$GLOBALS['lang']['usersearch_name']}</td>
    		<td class='colhead' align='left'>{$GLOBALS['lang']['usersearch_ratio']}</td>
        <td class='colhead' align='left'>{$GLOBALS['lang']['usersearch_ip']}</td>
        <td class='colhead' align='left'>{$GLOBALS['lang']['usersearch_email']}</td>".
        "<td class='colhead' align='left'>{$GLOBALS['lang']['usersearch_joined']}</td>".
        "<td class='colhead' align='left'>{$GLOBALS['lang']['usersearch_lastseen']}</td>".
        "<td class='colhead' align='left'>{$GLOBALS['lang']['usersearch_asts']}</td>".
        "<td class='colhead' align='left'>{$GLOBALS['lang']['usersearch_enabled']}</td>".
        "<td class='colhead'>{$GLOBALS['lang']['usersearch_pR']}</td>".
        "<td class='colhead'>{$GLOBALS['lang']['usersearch_pUL']}</td>".
        "<td class='colhead'>{$GLOBALS['lang']['usersearch_pDL']}</td>".
        "<td class='colhead'>{$GLOBALS['lang']['usersearch_history']}</td></tr>";
        $ids = '';
    while ($user = mysql_fetch_array($res))
    {
      ...
      {
	    	$nip = ip2long($user['ip']);
        $auxres = $GLOBALS['xoopsDB']->queryF("SELECT COUNT(*) FROM ".$GLOBALS['xoopsDB']->prefix("tb_bans")." WHERE $nip >= first AND $nip <= last") or sqlerr(__FILE__, __LINE__);
      ...
      $auxres = $GLOBALS['xoopsDB']->queryF("SELECT SUM(uploaded) AS pul, SUM(downloaded) AS pdl FROM ".$GLOBALS['xoopsDB']->prefix("tb_peers")." WHERE userid = ".$user['id']) or sqlerr(__FILE__, __LINE__);
...
//    $auxres = $GLOBALS['xoopsDB']->queryF("SELECT COUNT(id) FROM posts WHERE userid = ".$user['id']) or sqlerr(__FILE__, __LINE__);

      /*
      
      $auxres = $GLOBALS['xoopsDB']->queryF(
      "SELECT COUNT(DISTINCT p.id)
      FROM posts AS p LEFT JOIN topics as t ON p.topicid = t.id
      LEFT JOIN forums AS f ON t.forumid = f.id
      WHERE p.userid = " . $user['id'] . " AND f.minclassread <= " . $GLOBALS['CURUSER']['class']) or sqlerr(__FILE__, __LINE__);

      $n = mysql_fetch_row($auxres);
      $n_posts = $n[0];

      $auxres = $GLOBALS['xoopsDB']->queryF("SELECT COUNT(id) FROM comments WHERE user = ".$user['id']) or sqlerr(__FILE__, __LINE__);
			// Use LEFT JOIN to exclude orphan comments
      // $auxres = $GLOBALS['xoopsDB']->queryF("SELECT COUNT(c.id) FROM comments AS c LEFT JOIN ".$GLOBALS['xoopsDB']->prefix("tb_torrents")." as t ON c.torrent = t.id WHERE c.user = '".$user['id']."'") or sqlerr(__FILE__, __LINE__);
      $n = mysql_fetch_row($auxres);
      $n_comments = $n[0];
      $ids .= $user['id'].':';
...
$GLOBALS['tbTpl']->display('db:tb_cpanel_usersearch.html');
xoops_cp_footer();
exit(0);
