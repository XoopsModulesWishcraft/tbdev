...
$modversion['templates'][$i]['description'] = '';
$i++;
$modversion['templates'][$i]['file'] = 'tb_my.html';
$modversion['templates'][$i]['description'] = '';
$i++;
...
$modversion['templates'][$i]['description'] = '';
$i++;
$modversion['templates'][$i]['file'] = 'tb_torrenttable.html';
$modversion['templates'][$i]['description'] = '';
$i++;
$modversion['templates'][$i]['file'] = 'tb_header.html';
$modversion['templates'][$i]['description'] = '';
$i++;
$modversion['templates'][$i]['file'] = 'tb_footer.html';
$modversion['templates'][$i]['description'] = '';
$i++;
$modversion['templates'][$i]['file'] = 'tb_statusbar.html';
$modversion['templates'][$i]['description'] = '';
...
$modversion['config'][$i]['title'] = "_MI_TBDEV_EDITOR";
$modversion['config'][$i]['description'] = "_MI_TBDEV_EDITOR_DESC";
...
$i++;
$modversion['config'][$i]['name'] = 'group_user';
$modversion['config'][$i]['title'] = '_MI_TBDEV_GROUP_USER';
$modversion['config'][$i]['description'] = '_MI_TBDEV_GROUP_USER_DESC';
$modversion['config'][$i]['formtype'] = 'group';
$modversion['config'][$i]['valuetype'] = 'int';
$modversion['config'][$i]['default'] = XOOPS_GROUP_USERS;

$i++;
$modversion['config'][$i]['name'] = 'group_power_user';
$modversion['config'][$i]['title'] = '_MI_TBDEV_GROUP_POWER_USER';
$modversion['config'][$i]['description'] = '_MI_TBDEV_GROUP_POWER_USER_DESC';
$modversion['config'][$i]['formtype'] = 'group';
$modversion['config'][$i]['valuetype'] = 'int';
$criteria = new Criteria('group_type', _MI_TBDEV_GROUP_TYPE_POWERUSER);
$groups = $groups_handler->getObjects($criteria, false);
if (is_object($groups[0]))
	$modversion['config'][$i]['default'] = $groups[0]->getVar('groupid');

$i++;
$modversion['config'][$i]['name'] = 'group_vip';
$modversion['config'][$i]['title'] = '_MI_TBDEV_GROUP_VIP';
$modversion['config'][$i]['description'] = '_MI_TBDEV_GROUP_VIP_DESC';
$modversion['config'][$i]['formtype'] = 'group';
$modversion['config'][$i]['valuetype'] = 'int';
...
$i++;
$modversion['config'][$i]['name'] = 'group_uploader';
$modversion['config'][$i]['title'] = '_MI_TBDEV_GROUP_UPLOADER';
$modversion['config'][$i]['description'] = '_MI_TBDEV_GROUP_UPLOADER_DESC';
$modversion['config'][$i]['formtype'] = 'group';
$modversion['config'][$i]['valuetype'] = 'int';
...
$i++;
$modversion['config'][$i]['name'] = 'group_moderator';
$modversion['config'][$i]['title'] = '_MI_TBDEV_GROUP_MODERATOR';
$modversion['config'][$i]['description'] = '_MI_TBDEV_GROUP_MODERATOR_DESC';
$modversion['config'][$i]['formtype'] = 'group';
$modversion['config'][$i]['valuetype'] = 'int';
...
$i++;
$modversion['config'][$i]['name'] = 'group_administrator';
$modversion['config'][$i]['title'] = '_MI_TBDEV_GROUP_ADMINISTRATOR';
$modversion['config'][$i]['description'] = '_MI_TBDEV_GROUP_ADMINISTRATOR_DESC';
$modversion['config'][$i]['formtype'] = 'group';
$modversion['config'][$i]['valuetype'] = 'int';
...
$i++;
$modversion['config'][$i]['name'] = 'group_sysop';
$modversion['config'][$i]['title'] = '_MI_TBDEV_GROUP_SYSOP';
$modversion['config'][$i]['description'] = '_MI_TBDEV_GROUP_SYSOP_DESC';
$modversion['config'][$i]['formtype'] = 'group';
$modversion['config'][$i]['valuetype'] = 'int';
...
$i++;
$modversion['config'][$i]['name'] = 'agents_denied';
$modversion['config'][$i]['title'] = '_MI_TBDEV_AGENTS_DENIED';
$modversion['config'][$i]['description'] = '_MI_TBDEV_AGENTS_DENIED_DESC';
$modversion['config'][$i]['formtype'] = 'text';
$modversion['config'][$i]['valuetype'] = 'textarea';
$modversion['config'][$i]['default'] = '^Mozilla\\/|^Opera\\/|^Links |^Lynx\\/';

$i++;
$modversion['config'][$i]['name'] = 'server_denied';
$modversion['config'][$i]['title'] = '_MI_TBDEV_SERVER_DENIED';
$modversion['config'][$i]['description'] = '_MI_TBDEV_SERVER_DENIED_DESC';
$modversion['config'][$i]['formtype'] = 'text';
$modversion['config'][$i]['valuetype'] = 'textarea';
$modversion['config'][$i]['default'] = 'HTTP_COOKIE|HTTP_ACCEPT_LANGUAGE|HTTP_ACCEPT_CHARSET';

$i++;
$modversion['config'][$i]['name'] = 'ports_blacklisted';
$modversion['config'][$i]['title'] = '_MI_TBDEV_PORTS_BLACKLISTED';
$modversion['config'][$i]['description'] = '_MI_TBDEV_PORTS_BLACKLISTED_DESC';
$modversion['config'][$i]['formtype'] = 'text';
$modversion['config'][$i]['valuetype'] = 'textarea';
$modversion['config'][$i]['default'] = '411-413|6881-6889|1214|6346-6347|4662|6699';

$i++;
$modversion['config'][$i]['name'] = 'ratio_colours';
$modversion['config'][$i]['title'] = '_MI_TBDEV_RATIO_COLOURS';
$modversion['config'][$i]['description'] = '_MI_TBDEV_RATIO_COLOURS_DESC';
$modversion['config'][$i]['formtype'] = 'text';
$modversion['config'][$i]['valuetype'] = 'textarea';
$modversion['config'][$i]['default'] = '0.1-#ff0000|0.2-#ee0000|0.3-#dd0000|0.4-#cc0000|0.5-#bb0000|0.6-#aa0000|0.7-#990000|0.8-#880000|0.9-#770000|1-#660000';

$i++;
$modversion['config'][$i]['name'] = 'default_ratio_colour';
$modversion['config'][$i]['title'] = '_MI_TBDEV_DEFAULT_RATIO_COLOURS';
$modversion['config'][$i]['description'] = '_MI_TBDEV_DEFAULT_RATIO_COLOURS_DESC';
$modversion['config'][$i]['formtype'] = 'text';
$modversion['config'][$i]['valuetype'] = 'text';
$modversion['config'][$i]['default'] = '#000000';

$i++;
$modversion['config'][$i]['name'] = 'slr_colours';
$modversion['config'][$i]['title'] = '_MI_TBDEV_SLR_COLOURS';
$modversion['config'][$i]['description'] = '_MI_TBDEV_SLR_COLOURS_DESC';
$modversion['config'][$i]['formtype'] = 'text';
$modversion['config'][$i]['valuetype'] = 'textarea';
$modversion['config'][$i]['default'] = '0.025-#ff0000|0.05-#ee0000|0.075-#dd0000|0.1-#cc0000|0.125-#bb0000|0.15-#aa0000|0.175-#990000|0.2-#880000|0.225-#770000|0.25-#660000|0.275-#550000|0.3-#440000|0.325-#330000|0.35-#220000|0.375-#110000';

$i++;
$modversion['config'][$i]['name'] = 'default_slr_colour';
$modversion['config'][$i]['title'] = '_MI_TBDEV_DEFAULT_SLR_COLOURS';
$modversion['config'][$i]['description'] = '_MI_TBDEV_DEFAULT_SLR_COLOURS_DESC';
$modversion['config'][$i]['formtype'] = 'text';
$modversion['config'][$i]['valuetype'] = 'text';
$modversion['config'][$i]['default'] = '#000000';

$i++;
$modversion['config'][$i]['name'] = 'reserved_ips';
$modversion['config'][$i]['title'] = '_MI_TBDEV_RESERVED_IPS';
$modversion['config'][$i]['description'] = '_MI_TBDEV_RESERVED_IPS_DESC';
$modversion['config'][$i]['formtype'] = 'text';
$modversion['config'][$i]['valuetype'] = 'textarea';
$modversion['config'][$i]['default'] = '0.0.0.0-2.255.255.255|10.0.0.0-10.255.255.255|127.0.0.0-127.255.255.255|169.254.0.0-169.254.255.255|172.16.0.0-172.31.255.255|192.0.2.0-192.0.2.255|192.168.0.0-192.168.255.255|255.255.255.0-255.255.255.255';

$i++;
$modversion['config'][$i]['name'] = 'colors_cloud';
$modversion['config'][$i]['title'] = '_MI_TBDEV_COLORS_CLOUD';
$modversion['config'][$i]['description'] = '_MI_TBDEV_COLORS_CLOUD_DESC';
$modversion['config'][$i]['formtype'] = 'text';
$modversion['config'][$i]['valuetype'] = 'textarea';
$modversion['config'][$i]['default'] = 'yellow|green|blue|purple|orange|#0099FF';

$i++;
$modversion['config'][$i]['name'] = 'num_in_cloud';
$modversion['config'][$i]['title'] = '_MI_TBDEV_NUMBER_IN_CLOUD';
$modversion['config'][$i]['description'] = '_MI_TBDEV_NUMBER_IN_CLOUD_DESC';
$modversion['config'][$i]['formtype'] = 'text';
$modversion['config'][$i]['valuetype'] = 'int';
$modversion['config'][$i]['default'] = '50';

$i++;
$modversion['config'][$i]['name'] = 'cloud_font_small';
$modversion['config'][$i]['title'] = '_MI_TBDEV_CLOUD_FONT_SMALL';
$modversion['config'][$i]['description'] = '_MI_TBDEV_CLOUD_FONT_SMALL_DESC';
$modversion['config'][$i]['formtype'] = 'text';
$modversion['config'][$i]['valuetype'] = 'int';
$modversion['config'][$i]['default'] = '10';

$i++;
$modversion['config'][$i]['name'] = 'cloud_font_big';
$modversion['config'][$i]['title'] = '_MI_TBDEV_CLOUD_FONT_BIG';
$modversion['config'][$i]['description'] = '_MI_TBDEV_CLOUD_FONT_BIG_DESC';
$modversion['config'][$i]['formtype'] = 'text';
$modversion['config'][$i]['valuetype'] = 'int';
$modversion['config'][$i]['default'] = '35';

$i++;
$modversion['config'][$i]['name'] = 'support_mod_pm';
$modversion['config'][$i]['title'] = '_MI_TBDEV_SUPPORT_MODULE_PM';
$modversion['config'][$i]['description'] = '_MI_TBDEV_SUPPORT_MODULE_PM_DESC';
$modversion['config'][$i]['formtype'] = 'yesno';
$modversion['config'][$i]['valuetype'] = 'int';
$modversion['config'][$i]['default'] = true;

$i++;
$modversion['config'][$i]['name'] = 'support_mod_irc';
$modversion['config'][$i]['title'] = '_MI_TBDEV_SUPPORT_MODULE_IRC';
$modversion['config'][$i]['description'] = '_MI_TBDEV_SUPPORT_MODULE_IRC_DESC';
$modversion['config'][$i]['formtype'] = 'yesno';
$modversion['config'][$i]['valuetype'] = 'int';
$modversion['config'][$i]['default'] = false;

$i++;
$modversion['config'][$i]['name'] = 'support_mod_tags';
$modversion['config'][$i]['title'] = '_MI_TBDEV_SUPPORT_MODULE_TAGS';
$modversion['config'][$i]['description'] = '_MI_TBDEV_SUPPORT_MODULE_TAGS_DESC';
$modversion['config'][$i]['formtype'] = 'yesno';
$modversion['config'][$i]['valuetype'] = 'int';
$modversion['config'][$i]['default'] = true;
?>
