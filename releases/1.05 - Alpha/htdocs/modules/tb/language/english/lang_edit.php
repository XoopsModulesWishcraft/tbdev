...
'edit_reason' => "Reason:",
'edit_dead' => "Dead",
'edit_peers' => "0 seeders, 0 leechers = 0 ".$GLOBALS['xoopsDB']->prefix("tb_peers")." total",
'edit_dupe' => "Dupe",
'edit_nuked' => "Nuked",
'edit_rules' => "TB Rules",
'edit_req' => "req",
