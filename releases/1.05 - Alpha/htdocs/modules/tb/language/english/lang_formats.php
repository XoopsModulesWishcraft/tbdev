...
'formats_guide_body' => "Hey guys, here's some info about common ".$GLOBALS['xoopsDB']->prefix("tb_files")." that you can download from the internet,
and a little bit about using these ".$GLOBALS['xoopsDB']->prefix("tb_files")." for their intended purposes. If you're stuck
...
This is just a way of making the ".$GLOBALS['xoopsDB']->prefix("tb_files")." more compact and easier to download.<br />
<br />
...
<br />
These ".$GLOBALS['xoopsDB']->prefix("tb_files")." are usually movies or TVshows, or a host of other types of media. They can
...
to extract the ".$GLOBALS['xoopsDB']->prefix("tb_files")." and then burn them, or just access them from your hard drive. You can
...
<b>.ccd .img .sub</b><br />
<br />
All these ".$GLOBALS['xoopsDB']->prefix("tb_files")." go together and are in the <a href='http://www.elby.ch/english/products/clone_cd/index.html'> CloneCD</a> format. CloneCD is like most other CD-Burning programs,
...
<br />
These are text files. .txt ".$GLOBALS['xoopsDB']->prefix("tb_files")." can be opened with notepad or watever you default text
...
<br />
Basic image files. These ".$GLOBALS['xoopsDB']->prefix("tb_files")." generally contain pictures, and can be opened with Adobe
...
via torrent.) You can open/activate these ".$GLOBALS['xoopsDB']->prefix("tb_files")." with <a href='http://www.traction-software.co.uk/SFVChecker/'>
SFVChecker</a> (Trial version) or <a href='http://www.big-o-software.com/products/hksfv/'>hkSFV</a> for example.<br />
<br />
<br />
<p><b>.par</b></p>
This is a parity file, and is often used when downloading from newsgroups. These ".$GLOBALS['xoopsDB']->prefix("tb_files")." can
