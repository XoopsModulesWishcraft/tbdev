...
'faq_welcome' => "<b>Welcome to {$GLOBALS['TBDEV']['site_name']}!</b><br />
    ...
    permission to upload ".$GLOBALS['xoopsDB']->prefix("tb_torrents").". If you have access to 0-day stuff do not hesitate to
    ...
    Before you do anything here at {$GLOBALS['TBDEV']['site_name']} we suggest you read the <a class='altlink' href='rules.php'>rules</a>!
    There are only a few rules to abide by, but we do enforce them!<br />
    <br />
    Before you go any further you should read the {$GLOBALS['TBDEV']['site_name']} <a class='altlink' href='useragreement.php'>user agreement</a>.
    <br />",
...
'faq_userinfo' => "<ul>
        ...
        <img src='{$GLOBALS['TBDEV']['pic_base_url']}updated.png' alt='Updated' width='46' height='11' /></li>
...
'faq_stats' => "<ul>
        ...
        <li><a href='#stats6' class='altlink'>Why do I sometimes see ".$GLOBALS['xoopsDB']->prefix("tb_torrents")." I'm not leeching in my profile!?</a>
        <img src='{$GLOBALS['TBDEV']['pic_base_url']}/updated.png' alt='Updated' width='46' height='11' /></li>
...
'faq_uploading' => "<ul>
      ...
      <li><a href='#up3' class='altlink'>Can I upload your ".$GLOBALS['xoopsDB']->prefix("tb_torrents")." to other trackers?</a>
      <img src='{$GLOBALS['TBDEV']['pic_base_url']}new.png' alt='New' width='27' height='11' /></li>
      </ul>
    <br />",
'faq_downloading_header' => "Downloading",
'faq_downloading' => "<ul>
        <li><a href='#dl1' class='altlink'>How do I use the ".$GLOBALS['xoopsDB']->prefix("tb_files")." I've downloaded?</a></li>
...
'faq_siteinfo_body' => "<br />
    ...
    <br />
    {$GLOBALS['TBDEV']['site_name']} is situated on a dedicated server in the Netherlands.
...
'faq_userinfo_body' => "<b>I registered an account but did not receive the confirmation e-mail!</b><a name='user1' id='user1'></a><br />
    ...
    <br />
    <br />
    This means that other ".$GLOBALS['xoopsDB']->prefix("tb_peers")." in the swarm will be unable to connect to you, only you to them. Even worse,
    if two ".$GLOBALS['xoopsDB']->prefix("tb_peers")." are both in this state they will not be able to connect at all. This has obviously a
    ...
    <tr>
      <td class='embedded' bgcolor='#F5F4EA'>&nbsp;  <img src='{$GLOBALS['TBDEV']['pic_base_url']}star.gif' alt='Star' /></td>
      <td class='embedded' width='5'>&nbsp;</td>
      <td class='embedded'>Has donated money to {$GLOBALS['TBDEV']['site_name']} . </td>
    </tr>
    <tr>
      <td class='embedded' valign='top' bgcolor='#F5F4EA'>&nbsp; <b>VIP</b></td>
      <td class='embedded' width='5'>&nbsp;</td>
      <td class='embedded' valign='top'>Same privileges as Power User and is considered an Elite Member of {$GLOBALS['TBDEV']['site_name']}. Immune to automatic demotion.</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td class='embedded' width='5'>&nbsp;</td>
      <td class='embedded' valign='top'>Can edit and delete any uploaded ".$GLOBALS['xoopsDB']->prefix("tb_torrents").". Can also moderate user	comments and disable accounts.</td>
    </tr>
    <tr>
...
'faq_stats_body' => "<br />
    ...
    * TorrentStorm.<br />
    ...
    the stats near the end, and ".$GLOBALS['xoopsDB']->prefix("tb_torrents")." may still be listed in your profile for some time after you have closed the client.<br />
    <br />
    ...
    <br />
    <br />
    <b>Why do I sometimes see ".$GLOBALS['xoopsDB']->prefix("tb_torrents")." I'm not leeching in my profile!?</b><a name='stats6'></a><br />
    <br />
    ...
    you may occasionally see their ".$GLOBALS['xoopsDB']->prefix("tb_torrents")." listed in your profile. (If they start a torrent session from that
    IP and you were the last one to visit the site the torrent will be associated with you). Note that now
    ".$GLOBALS['xoopsDB']->prefix("tb_torrents")." listed in your profile will always count towards your total stats.
    <br />
    <br />
    To make sure your ".$GLOBALS['xoopsDB']->prefix("tb_torrents")." show up in your profile you should visit the site immediately before starting a session.
    <br />
    <br />
    (The only way to completely stop foreign ".$GLOBALS['xoopsDB']->prefix("tb_torrents")." from showing in profiles is to forbid ".$GLOBALS['xoopsDB']->prefix("tb_users")." without
...
'faq_uploading_body' => "<br />
    ...
    <br />
    Only specially authorized ".$GLOBALS['xoopsDB']->prefix("tb_users")." (<font color='#4040C0'><b>Uploaders</b></font>) have permission to upload ".$GLOBALS['xoopsDB']->prefix("tb_torrents").".<br />
    <br />
    <br />
    ...
    * have all ".$GLOBALS['xoopsDB']->prefix("tb_files")." in original format (usually 14.3 MB RARs),<br />
    * you'll be able to seed, or make sure are well-seeded, for at least 24 hours.<br />
    ...
    <br />
    <br />
    <b>Can I upload your ".$GLOBALS['xoopsDB']->prefix("tb_torrents")." to other trackers?</b><a name='up3'></a><br />
    <br />
    No. We are a closed, limited-membership community. Only registered ".$GLOBALS['xoopsDB']->prefix("tb_users")." can use the TB tracker.
    Posting our ".$GLOBALS['xoopsDB']->prefix("tb_torrents")." on other trackers is useless, since most people who attempt to download them will
    ...
    <br />
    Complaints from other sites' administrative staff about our ".$GLOBALS['xoopsDB']->prefix("tb_torrents")." being posted on their sites will
    result in the banning of the ".$GLOBALS['xoopsDB']->prefix("tb_users")." responsible.<br />
    <br />
    (However, the ".$GLOBALS['xoopsDB']->prefix("tb_files")." you download from us are yours to do as you please. You can always create another
    torrent, pointing to some other tracker, and upload it to the site of your choice.)<br />",
'faq_downloading_body' => "<br />
    <b>How do I use the ".$GLOBALS['xoopsDB']->prefix("tb_files")." I've downloaded?</b><a name='dl1'></a><br />
    <br />
    ...
    <br />
    The more pieces you have, the harder it becomes to find ".$GLOBALS['xoopsDB']->prefix("tb_peers")." who have pieces you are missing.
...
'faq_downloading_body1' => "This applies to new ".$GLOBALS['xoopsDB']->prefix("tb_users")." as well, so opening a new account will not help. Note also that this
    ...
    <br />
    <!--The delay applies only to leeching, not to seeding. If you got the ".$GLOBALS['xoopsDB']->prefix("tb_files")." from any other source and
    ...
    now applies to both seeding and leeching. So if you are subject to a delay and get the ".$GLOBALS['xoopsDB']->prefix("tb_files")." from
    ...
    <br />
    {$GLOBALS['TBDEV']['site_name']} does not allow clients to use ports commonly associated with p2p protocols.
    ...
    should <i>increase</i> your speed with ".$GLOBALS['xoopsDB']->prefix("tb_torrents")." from any tracker, not just ours). Your client
    will also still be able to connect to ".$GLOBALS['xoopsDB']->prefix("tb_peers")." that are using the standard ports.
...
'faq_downloading_body2' => "<b>What's this 'IOError - [Errno13] Permission denied' error?</b><a name='dla'></a><br />
    ...
    that makes the partially downloaded ".$GLOBALS['xoopsDB']->prefix("tb_files")." unreadable, and the error ensues. Running
...
'faq_improve_speed_body' => "The download speed mostly depends on the seeder-to-leecher ratio (SLR). Poor download speed is
    mainly a problem with new and very popular ".$GLOBALS['xoopsDB']->prefix("tb_torrents")." where the SLR is low.<br />
    <br />
    ...
    <ul>
        <li>Bittorrent ".$GLOBALS['xoopsDB']->prefix("tb_peers")." tend to favour those other ".$GLOBALS['xoopsDB']->prefix("tb_peers")." that upload to them. This means that if A and B
    ...
    <br />
    Isn't this the same as above? No. Connections limit the number of ".$GLOBALS['xoopsDB']->prefix("tb_peers")." your client is talking to and/or
    downloading from. Uploads limit the number of ".$GLOBALS['xoopsDB']->prefix("tb_peers")." your client is actually uploading to. The ideal number is
    ...
    <br />
    As explained above ".$GLOBALS['xoopsDB']->prefix("tb_peers")." favour other ".$GLOBALS['xoopsDB']->prefix("tb_peers")." that upload to them. When you start leeching a new torrent you have
    nothing to offer to other ".$GLOBALS['xoopsDB']->prefix("tb_peers")." and they will tend to ignore you. This makes the starts slow, in particular if,
    by change, the ".$GLOBALS['xoopsDB']->prefix("tb_peers")." you are connected to include few or no seeders. The download speed should increase as soon
...
'faq_proxy_body2' => "<tr>
    ...
    <br />
    The {$GLOBALS['TBDEV']['site_name']} tracker is quite smart at finding your real IP, but it does need the proxy to send the HTTP header
    ...
    thing to try should be connecting to {$GLOBALS['TBDEV']['baseurl']}:81. Note that even if this works your bt client will still try
    ...
    <ul>
      ...
      the list followed by your IP then everything should be ok, otherwise choose another proxy and try again.<br /></li>
        ...
        <li>Visit {$GLOBALS['TBDEV']['site_name']}. Hopefully the tracker will now pickup your real IP (check your profile to make sure).</li>
    </ul>
    <br />
    Notice that now you will be doing all your browsing through a public proxy, which are typically quite slow.
    Communications between ".$GLOBALS['xoopsDB']->prefix("tb_peers")." do not use port 80 so their speed will not be affected by this, and should be better than when
    ...
    <br />
    This section was written for {$GLOBALS['TBDEV']['site_name']}, a closed, port 80-81 tracker. Other trackers may be open or closed, and many listen
...
'faq_blocked_body' => "<br />
    ...
    database, as well as addresses of banned ".$GLOBALS['xoopsDB']->prefix("tb_users").". This works at Apache/PHP level, it's just a script that
...
'faq_alt_port_body' => "<br />
    Some of our ".$GLOBALS['xoopsDB']->prefix("tb_torrents")." use ports other than the usual HTTP port 80. This may cause problems for some users,
    ...
    and replacing the announce url {$GLOBALS['TBDEV']['baseurl']}:81 with {$GLOBALS['TBDEV']['site_name']}:80 or just {$GLOBALS['TBDEV']['site_name']}.<br />
    <br />
    ...
    {$GLOBALS['TBDEV']['site_name']}:80, not {$GLOBALS['TBDEV']['site_name']}. (If you're thinking about changing the number before the
...
'faq_problem_body' => "<br />
    ...
    error message you get, if any? What are the ".$GLOBALS['xoopsDB']->prefix("tb_torrents")." you are having problems with? The more
