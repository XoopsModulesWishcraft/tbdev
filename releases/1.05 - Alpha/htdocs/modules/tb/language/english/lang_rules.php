...
'rules_general_body' => "<ul>
    ...
    <li>Do not upload our ".$GLOBALS['xoopsDB']->prefix("tb_torrents")." to other trackers! (See the <a href='faq.php#up3' class='altlink'><b>FAQ</b></a> for details.)</li>
    <li><a name='warning'></a>Disruptive behaviour in the forums or on the game server will result in a warning (<img src='{$GLOBALS['TBDEV']['pic_base_url']}warned.gif' alt='' /> ).<br />
...
'rules_downloading_body' => "<ul>
    <li>Access to the newest ".$GLOBALS['xoopsDB']->prefix("tb_torrents")." is conditional on a good ratio! (See the <a href='faq.php#dl8' class='altlink'><b>FAQ</b></a> for details.)</li>
...
'rules_uploading_body' => "<ul>
      ...
      <li>All ".$GLOBALS['xoopsDB']->prefix("tb_files")." must be in original format (usually 14.3 MB RARs).</li>
      ...
      <li>Make sure your ".$GLOBALS['xoopsDB']->prefix("tb_torrents")." are well-seeded for at least 24 hours.</li>
      <li>Do not include the release date in the torrent name.</li>
      <li>Stay active! You risk being demoted if you have no active ".$GLOBALS['xoopsDB']->prefix("tb_torrents").".</li>
      </ul>
      <br />
...
'rules_mod_options_body' => "<ul>
      ...
      <li>You can delete and edit ".$GLOBALS['xoopsDB']->prefix("tb_torrents").".</li>
      ...
      <li>You can see the complete info of all ".$GLOBALS['xoopsDB']->prefix("tb_users").".</li>
