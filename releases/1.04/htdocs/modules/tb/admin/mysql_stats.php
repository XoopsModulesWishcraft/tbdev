...
////////////////////// END FUNCTION LIST /////////////////////////////////////
    ...
    $res = @$GLOBALS['xoopsDB']->queryF('SHOW STATUS') or sqlerr(__FILE__,__LINE__);
    ...
    $res = @$GLOBALS['xoopsDB']->queryF('SELECT UNIX_TIMESTAMP() - ' . $serverStatus['Uptime']);
    ...
    $GLOBALS['tbTpl']->display('db:tb_cpanel_mysql_stats.html');
	xoops_cp_footer();
	exit(0);
