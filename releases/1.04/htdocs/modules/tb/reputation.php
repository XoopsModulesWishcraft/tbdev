...
///////////////////////////////////////////////
		$forum = $GLOBALS['xoopsDB']->queryF( "SELECT posts.topicid, posts.userid, forums.minclassread, 
								".$GLOBALS['xoopsDB']->prefix("tb_users").".username, ".$GLOBALS['xoopsDB']->prefix("tb_users").".reputation 
								FROM posts 
								LEFT JOIN topics ON topicid = topics.id 
								LEFT JOIN forums ON topics.forumid = forums.id 
								LEFT JOIN ".$GLOBALS['xoopsDB']->prefix("tb_users")." ON posts.userid = ".$GLOBALS['xoopsDB']->prefix("tb_users").".id 
...
///////////////////////////////////////////////
		$repeat = $GLOBALS['xoopsDB']->queryF( "SELECT postid FROM ".$GLOBALS['xoopsDB']->prefix("tb_reputation")." WHERE postid ={$input['pid']} 
...
///////////////////////////////////////////////
			$flood = $GLOBALS['xoopsDB']->queryF( "SELECT dateadd, userid FROM ".$GLOBALS['xoopsDB']->prefix("tb_reputation")." 
...
///////////////////////////////////////////////
		if( isset( $input['do'] ) && $input['do']  == 'addrep' )
		{
			...
			@$GLOBALS['xoopsDB']->queryF( "INSERT INTO ".$GLOBALS['xoopsDB']->prefix("tb_reputation")." (".join(',', array_keys($save)).") VALUES (".join( ',', $save).")" );
