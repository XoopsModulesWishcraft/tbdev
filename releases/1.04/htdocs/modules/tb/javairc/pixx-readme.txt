...
Files
-----
  The following ".$GLOBALS['xoopsDB']->prefix("tb_files")." are part of the Pixx GUI:
    pixx.cab : Pixx GUI for Internet Explorer VM.
    pixx.jar : Pixx GUI for Sun JVM.

Installation
------------
  Upload both ".$GLOBALS['xoopsDB']->prefix("tb_files")." to your PJIRC directory, and add them to the file list in
...
Have a look to http://www.pjirc.com/ for ".$GLOBALS['xoopsDB']->prefix("tb_news")." about PJIRC.
