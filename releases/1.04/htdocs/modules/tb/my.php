...
loggedinorreturn();
    ...
    ****************/
    $stylesheets ='';
    $ss_r = $GLOBALS['xoopsDB']->queryF("SELECT * from ".$GLOBALS['xoopsDB']->prefix("tb_stylesheets")."") or die;
    $ss_sa = array();
    ...
    $ct_r = $GLOBALS['xoopsDB']->queryF("SELECT id,name FROM ".$GLOBALS['xoopsDB']->prefix("tb_countries")." ORDER BY name") or sqlerr(__FILE__,__LINE__);
    ...
    $r = $GLOBALS['xoopsDB']->queryF("SELECT id,name FROM ".$GLOBALS['xoopsDB']->prefix("tb_categories")." ORDER BY name") or sqlerr();
