...
'tags_tags' => "Tags",
'tags_title' => "<p>The {$GLOBALS['TBDEV']['site_name']} forums supports a number of <i>BB tags</i> which you can embed to modify how your posts are displayed.</p>",
...
'tags_hyper4' => "[url]".$GLOBALS['TBDEV']['baseurl']."/[/url]",
...
'tags_hyper9' => "[url=".$GLOBALS['TBDEV']['baseurl']."/]".$GLOBALS['TBDEV']['site_name']."[/url]",
...
'tags_image4' => "[img=".$GLOBALS['TBDEV']['baseurl']."/pic/logo.gif]",
...
'tags_image9' => "[img]".$GLOBALS['TBDEV']['baseurl']."/pic/logo.gif[/img]",
