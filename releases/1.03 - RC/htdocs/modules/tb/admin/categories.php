...
|   $Revision: 208 $
|   $Author: tbdevnet $
|   $URL: admin/".$GLOBALS['xoopsDB']->prefix("categories").".php $
+------------------------------------------------
*/
...
function move_cat_form() {
    ...
    $htmlout .= "<form action='admin.php?action=categories' method='post'>
      ...
      <tr>
        <td colspan='2'>Note: This tool will move ALL ".$GLOBALS['xoopsDB']->prefix("torrents")." FROM one category to ANOTHER category only! It will NOT delete any ".$GLOBALS['xoopsDB']->prefix("categories")." or ".$GLOBALS['xoopsDB']->prefix("torrents").".</td>
      </tr>
      <tr>
