...
loggedinorreturn();
    ...
    if (isset($_GET["hit"])) 
    {
      $GLOBALS['xoopsDB']->queryF("UPDATE ".$GLOBALS['xoopsDB']->prefix("torrents")." SET views = views + 1 WHERE id = $id");
      /* if ($_GET["tocomm"])
...
$res = $GLOBALS['xoopsDB']->queryF("SELECT ".$GLOBALS['xoopsDB']->prefix("torrents").".seeders, ".$GLOBALS['xoopsDB']->prefix("torrents").".banned, ".$GLOBALS['xoopsDB']->prefix("torrents").".leechers, ".$GLOBALS['xoopsDB']->prefix("torrents").".info_hash, ".$GLOBALS['xoopsDB']->prefix("torrents").".filename, LENGTH(".$GLOBALS['xoopsDB']->prefix("torrents").".nfo) AS nfosz, ".$GLOBALS['xoopsDB']->prefix("torrents").".last_action AS lastseed, ".$GLOBALS['xoopsDB']->prefix("torrents").".numratings, ".$GLOBALS['xoopsDB']->prefix("torrents").".name, IF(".$GLOBALS['xoopsDB']->prefix("torrents").".numratings < {$GLOBALS['TBDEV']['minvotes']}, NULL, ROUND(".$GLOBALS['xoopsDB']->prefix("torrents").".ratingsum / ".$GLOBALS['xoopsDB']->prefix("torrents").".numratings, 1)) AS rating, ".$GLOBALS['xoopsDB']->prefix("torrents").".comments, ".$GLOBALS['xoopsDB']->prefix("torrents").".owner, ".$GLOBALS['xoopsDB']->prefix("torrents").".save_as, ".$GLOBALS['xoopsDB']->prefix("torrents").".descr, ".$GLOBALS['xoopsDB']->prefix("torrents").".visible, ".$GLOBALS['xoopsDB']->prefix("torrents").".size, ".$GLOBALS['xoopsDB']->prefix("torrents").".added, ".$GLOBALS['xoopsDB']->prefix("torrents").".views, ".$GLOBALS['xoopsDB']->prefix("torrents").".hits, ".$GLOBALS['xoopsDB']->prefix("torrents").".times_completed, ".$GLOBALS['xoopsDB']->prefix("torrents").".id, ".$GLOBALS['xoopsDB']->prefix("torrents").".type, ".$GLOBALS['xoopsDB']->prefix("torrents").".numfiles, ".$GLOBALS['xoopsDB']->prefix("categories").".name AS cat_name, ".$GLOBALS['xoopsDB']->prefix("tb_users").".username FROM ".$GLOBALS['xoopsDB']->prefix("torrents")." LEFT JOIN ".$GLOBALS['xoopsDB']->prefix("categories")." ON ".$GLOBALS['xoopsDB']->prefix("torrents").".category = ".$GLOBALS['xoopsDB']->prefix("categories").".id LEFT JOIN ".$GLOBALS['xoopsDB']->prefix("tb_users")." ON ".$GLOBALS['xoopsDB']->prefix("torrents").".owner = ".$GLOBALS['xoopsDB']->prefix("tb_users").".id WHERE ".$GLOBALS['xoopsDB']->prefix("torrents").".id = $id")
	or sqlerr();
