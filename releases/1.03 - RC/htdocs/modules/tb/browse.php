...
loggedinorreturn();
    ...
    $orderby = "ORDER BY ".$GLOBALS['xoopsDB']->prefix("torrents").".id DESC";
    ...
    if ($count)
    {
      ...
      $query = "SELECT ".$GLOBALS['xoopsDB']->prefix("torrents").".id, ".$GLOBALS['xoopsDB']->prefix("torrents").".category, ".$GLOBALS['xoopsDB']->prefix("torrents").".leechers, ".$GLOBALS['xoopsDB']->prefix("torrents").".seeders, ".$GLOBALS['xoopsDB']->prefix("torrents").".name, ".$GLOBALS['xoopsDB']->prefix("torrents").".times_completed, ".$GLOBALS['xoopsDB']->prefix("torrents").".size, ".$GLOBALS['xoopsDB']->prefix("torrents").".added, ".$GLOBALS['xoopsDB']->prefix("torrents").".type,  ".$GLOBALS['xoopsDB']->prefix("torrents").".comments,".$GLOBALS['xoopsDB']->prefix("torrents").".numfiles,".$GLOBALS['xoopsDB']->prefix("torrents").".filename,".$GLOBALS['xoopsDB']->prefix("torrents").".owner,IF(".$GLOBALS['xoopsDB']->prefix("torrents").".nfo <> '', 1, 0) as nfoav," .
    //	"IF(".$GLOBALS['xoopsDB']->prefix("torrents").".numratings < {$GLOBALS['TBDEV']['minvotes']}, NULL, ROUND(".$GLOBALS['xoopsDB']->prefix("torrents").".ratingsum / ".$GLOBALS['xoopsDB']->prefix("torrents").".numratings, 1)) AS rating, ".$GLOBALS['xoopsDB']->prefix("categories").".name AS cat_name, ".$GLOBALS['xoopsDB']->prefix("categories").".image AS cat_pic, ".$GLOBALS['xoopsDB']->prefix("tb_users").".username FROM ".$GLOBALS['xoopsDB']->prefix("torrents")." LEFT JOIN ".$GLOBALS['xoopsDB']->prefix("categories")." ON category = ".$GLOBALS['xoopsDB']->prefix("categories").".id LEFT JOIN ".$GLOBALS['xoopsDB']->prefix("tb_users")." ON ".$GLOBALS['xoopsDB']->prefix("torrents").".owner = ".$GLOBALS['xoopsDB']->prefix("tb_users").".id $where $orderby $limit";
      "".$GLOBALS['xoopsDB']->prefix("categories").".name AS cat_name, ".$GLOBALS['xoopsDB']->prefix("categories").".image AS cat_pic, ".$GLOBALS['xoopsDB']->prefix("tb_users").".username FROM ".$GLOBALS['xoopsDB']->prefix("torrents")." LEFT JOIN ".$GLOBALS['xoopsDB']->prefix("categories")." ON category = ".$GLOBALS['xoopsDB']->prefix("categories").".id LEFT JOIN ".$GLOBALS['xoopsDB']->prefix("tb_users")." ON ".$GLOBALS['xoopsDB']->prefix("torrents").".owner = ".$GLOBALS['xoopsDB']->prefix("tb_users").".id $where $orderby {$pager['limit']}";
