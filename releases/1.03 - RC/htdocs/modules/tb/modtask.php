...
if ((isset($_POST['action'])) && ($_POST['action'] == "edituser"))
    ...
    $msg = sqlesc("You have been given upload rights by " . $GLOBALS['CURUSER']['username'] . ". You can now upload ".$GLOBALS['xoopsDB']->prefix("torrents").".");
    $added = time();
    $GLOBALS['xoopsDB']->queryF("INSERT INTO messages (sender, receiver, msg, added) VALUES (0, $userid, $msg, $added)") or sqlerr(__FILE__, __LINE__);
    }
    elseif ($uploadpos == 'no')
    ...
    $msg = sqlesc("Your download rights have been given back by " . $GLOBALS['CURUSER']['username'] . ". You can download ".$GLOBALS['xoopsDB']->prefix("torrents")." again.");
    $added = time();
    $GLOBALS['xoopsDB']->queryF("INSERT INTO messages (sender, receiver, msg, added) VALUES (0, $userid, $msg, $added)") or sqlerr(__FILE__, __LINE__);
    }
