...
'faq_welcome' => "<b>Welcome to {$GLOBALS['TBDEV']['site_name']}!</b><br />
    ...
    permission to upload ".$GLOBALS['xoopsDB']->prefix("torrents").". If you have access to 0-day stuff do not hesitate to
...
'faq_stats' => "<ul>
        ...
        <li><a href='#stats6' class='altlink'>Why do I sometimes see ".$GLOBALS['xoopsDB']->prefix("torrents")." I'm not leeching in my profile!?</a>
        <img src='{$GLOBALS['TBDEV']['pic_base_url']}/updated.png' alt='Updated' width='46' height='11' /></li>
...
'faq_uploading' => "<ul>
      ...
      <li><a href='#up3' class='altlink'>Can I upload your ".$GLOBALS['xoopsDB']->prefix("torrents")." to other trackers?</a>
      <img src='{$GLOBALS['TBDEV']['pic_base_url']}new.png' alt='New' width='27' height='11' /></li>
      </ul>
    <br />",
'faq_downloading_header' => "Downloading",
'faq_downloading' => "<ul>
        <li><a href='#dl1' class='altlink'>How do I use the ".$GLOBALS['xoopsDB']->prefix("files")." I've downloaded?</a></li>
...
'faq_userinfo_body' => "<b>I registered an account but did not receive the confirmation e-mail!</b><a name='user1' id='user1'></a><br />
    ...
    <br />
    <br />
    This means that other ".$GLOBALS['xoopsDB']->prefix("peers")." in the swarm will be unable to connect to you, only you to them. Even worse,
    if two ".$GLOBALS['xoopsDB']->prefix("peers")." are both in this state they will not be able to connect at all. This has obviously a
    ...
    <tr>
      ...
      <td class='embedded' width='5'>&nbsp;</td>
      <td class='embedded' valign='top'>Can edit and delete any uploaded ".$GLOBALS['xoopsDB']->prefix("torrents").". Can also moderate user	comments and disable accounts.</td>
    </tr>
    <tr>
...
'faq_stats_body' => "<br />
    ...
    * TorrentStorm.<br />
    ...
    the stats near the end, and ".$GLOBALS['xoopsDB']->prefix("torrents")." may still be listed in your profile for some time after you have closed the client.<br />
    <br />
    ...
    <br />
    <br />
    <b>Why do I sometimes see ".$GLOBALS['xoopsDB']->prefix("torrents")." I'm not leeching in my profile!?</b><a name='stats6'></a><br />
    <br />
    ...
    you may occasionally see their ".$GLOBALS['xoopsDB']->prefix("torrents")." listed in your profile. (If they start a torrent session from that
    IP and you were the last one to visit the site the torrent will be associated with you). Note that now
    ".$GLOBALS['xoopsDB']->prefix("torrents")." listed in your profile will always count towards your total stats.
    <br />
    <br />
...
'faq_uploading_body' => "<br />
    ...
    <br />
    Only specially authorized ".$GLOBALS['xoopsDB']->prefix("tb_users")." (<font color='#4040C0'><b>Uploaders</b></font>) have permission to upload ".$GLOBALS['xoopsDB']->prefix("torrents").".<br />
    <br />
    <br />
    ...
    * have all ".$GLOBALS['xoopsDB']->prefix("files")." in original format (usually 14.3 MB RARs),<br />
...
'faq_downloading_body' => "<br />
    <b>How do I use the ".$GLOBALS['xoopsDB']->prefix("files")." I've downloaded?</b><a name='dl1'></a><br />
    <br />
    ...
    <br />
    The more pieces you have, the harder it becomes to find ".$GLOBALS['xoopsDB']->prefix("peers")." who have pieces you are missing.
...
'faq_downloading_body1' => "This applies to new ".$GLOBALS['xoopsDB']->prefix("tb_users")." as well, so opening a new account will not help. Note also that this
    ...
    should <i>increase</i> your speed with ".$GLOBALS['xoopsDB']->prefix("torrents")." from any tracker, not just ours). Your client
    will also still be able to connect to ".$GLOBALS['xoopsDB']->prefix("peers")." that are using the standard ports.
...
'faq_downloading_body2' => "<b>What's this 'IOError - [Errno13] Permission denied' error?</b><a name='dla'></a><br />
    ...
    that makes the partially downloaded ".$GLOBALS['xoopsDB']->prefix("files")." unreadable, and the error ensues. Running
...
'faq_improve_speed_body' => "The download speed mostly depends on the seeder-to-leecher ratio (SLR). Poor download speed is
    mainly a problem with new and very popular ".$GLOBALS['xoopsDB']->prefix("torrents")." where the SLR is low.<br />
    <br />
    ...
    <ul>
        <li>Bittorrent ".$GLOBALS['xoopsDB']->prefix("peers")." tend to favour those other ".$GLOBALS['xoopsDB']->prefix("peers")." that upload to them. This means that if A and B
    ...
    <br />
    Isn't this the same as above? No. Connections limit the number of ".$GLOBALS['xoopsDB']->prefix("peers")." your client is talking to and/or
    downloading from. Uploads limit the number of ".$GLOBALS['xoopsDB']->prefix("peers")." your client is actually uploading to. The ideal number is
    ...
    <br />
    As explained above ".$GLOBALS['xoopsDB']->prefix("peers")." favour other ".$GLOBALS['xoopsDB']->prefix("peers")." that upload to them. When you start leeching a new torrent you have
    nothing to offer to other ".$GLOBALS['xoopsDB']->prefix("peers")." and they will tend to ignore you. This makes the starts slow, in particular if,
    by change, the ".$GLOBALS['xoopsDB']->prefix("peers")." you are connected to include few or no seeders. The download speed should increase as soon
...
'faq_proxy_body2' => "<tr>
    ...
    Communications between ".$GLOBALS['xoopsDB']->prefix("peers")." do not use port 80 so their speed will not be affected by this, and should be better than when
...
'faq_alt_port_body' => "<br />
    Some of our ".$GLOBALS['xoopsDB']->prefix("torrents")." use ports other than the usual HTTP port 80. This may cause problems for some users,
...
'faq_problem_body' => "<br />
    ...
    error message you get, if any? What are the ".$GLOBALS['xoopsDB']->prefix("torrents")." you are having problems with? The more
