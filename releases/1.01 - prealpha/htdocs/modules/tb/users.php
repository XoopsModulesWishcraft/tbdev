...
loggedinorreturn();
    ...
    $GLOBALS['lang'] = array_merge( load_language('global'), load_language('users') );
    ...
    if ($page == 1)
      ...
      $browsemenu .= "<a href='users.php?$q&amp;page=1' title='{$GLOBALS['lang']['pager_first']}(1)'><span class='btn'>&laquo;</span></a>&nbsp;<a href='users.php?$q&amp;page=" . ($page - 1) . "'><span class='btn'>&lsaquo;</span></a>$pagemenu";
    ...
    if ($page == $pages)
      ...
      $browsemenu .= "<a href='users.php?$q&amp;page=" . ($page + 1) . "'><span class='btn'>&rsaquo;</span></a>&nbsp;<a href='users.php?$q&amp;page=" . $pages . "' title='{$GLOBALS['lang']['pager_last']}($pages)'><span class='btn'>&raquo;</span></a>";
    }
    ...
    */    
    ...
    print stdhead($GLOBALS['lang']['head_users']) . $HTMLOUT . stdfoot();
    die;
