...
loggedinorreturn();
    ...
    $GLOBALS['lang'] = array_merge( load_language('global'), load_language('takeedit') );
    ...
    $res = $GLOBALS['xoopsDB']->queryF("SELECT owner, filename, save_as FROM ".$GLOBALS['xoopsDB']->prefix("torrents")." WHERE id = $id");
    ...
    $GLOBALS['xoopsDB']->queryF("UPDATE ".$GLOBALS['xoopsDB']->prefix("torrents")." SET " . join(",", $updateset) . " WHERE id = $id");
