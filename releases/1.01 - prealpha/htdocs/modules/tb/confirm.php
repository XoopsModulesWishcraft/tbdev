...
require_once "include/user_functions.php";
    ...
    $res = @$GLOBALS['xoopsDB']->queryF("SELECT passhash, editsecret, status FROM ".$GLOBALS['xoopsDB']->prefix("users")." WHERE id = $id");
    ...
    @$GLOBALS['xoopsDB']->queryF("UPDATE ".$GLOBALS['xoopsDB']->prefix("users")." SET status='confirmed', editsecret='' WHERE id=$id AND status='pending'");
