...
require_once "include/user_functions.php";
    ...
    {
      @$GLOBALS['xoopsDB']->queryF("DELETE FROM ".$GLOBALS['xoopsDB']->prefix("bans")." WHERE id=$remove") or sqlerr();
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST" && $GLOBALS['CURUSER']['class'] >= UC_ADMINISTRATOR)
    {
      ...
      else
      {
        ...
        $GLOBALS['xoopsDB']->queryF("INSERT INTO ".$GLOBALS['xoopsDB']->prefix("bans")." (added, addedby, first, last, comment) 
