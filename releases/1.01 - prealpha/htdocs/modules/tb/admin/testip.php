...
require_once "include/user_functions.php";
    ...
    if ($ip)
    {
      ...
      $res = $GLOBALS['xoopsDB']->queryF("SELECT * FROM ".$GLOBALS['xoopsDB']->prefix("bans")." WHERE $nip >= first AND $nip <= last") or sqlerr(__FILE__, __LINE__);
    ...
    print stdhead($GLOBALS['lang']['testip_windows_title']) . $HTMLOUT . stdfoot();
?>